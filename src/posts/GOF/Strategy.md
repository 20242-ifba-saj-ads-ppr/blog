...
class Personagem{
    - atributosDoPersonagem
    + void metodos()
    + void {abstract} mover()
}
class PersonagemAnda extends Personagem{
    void mover()
}
class PersonagemCorre extends Personagem{
    void mover()
}

note top of PersonagemAnda : Personagem instanciando\nnunca corre
note top of PersonagemCorre : Personagem instanciando\nnunca anda

note left of PersonagemAnda::"mover()"
  Mover com passo 1
end note
note right of PersonagemCorre::"mover()"
  Mover com passo 2
end note

```

<figcaption>Sem Strategy.</figcaption>
</figure>
...
abstract Movimento{
    void {abstract} desloca()
}
Personagem o- Movimento : "movimento"

class Anda extends Movimento{
    void  desloca()
}
class Corre extends Movimento{
    void  desloca()
}
note top of Movimento : Personagem depois de \ninstanciando pode mudar\na estrategia de movimento

note left of Anda::"desloca()"
  desloca com passo 1
end note

note left of Personagem::"mover()"
  movimento.desloca()
end note

note left of Corre::"desloca()"
  desloca com passo 2
end note
```
<figcaption>Com Strategy.</figcaption>
</figure>
...
```
Um código que contém muitos estados frequentemente indica a necessidade de aplicar o padrão Strategy.
